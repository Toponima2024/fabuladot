...
import SectionBase from "@layouts/components/SectionBase";
import SectionInfo from "@layouts/components/SectionInfo"
        ...
        <div className="max-w-sm mx-auto bg-white rounded-lg shadow-md overflow-hidden mt-5 ">
          <div className="p-6">
              ...
              <div className="flex justify-center w-full">
                <div className="flex justify-center w-full mb-2">
                        <button
                  className="bg-[#2A2D7D] hover:bg-white text-white hover:text-[#2A2D7D] font-bold rounded-full transition text-base px-20 py-2"
                  style={{ fontFamily: "Lato"  }}
                        >
                          Hablemos
                        </button>
