...
const InfoSection = () => {
    return (
        <section className="section relative bg-primary h-[45vh] sm:h-[25vh] md:h-[42vh] lg:h-[30vh] xl:h-[45vh]">
          ...
          {/* Segundo div (abajo) */}
          <div className="absolute bottom-0 inset-x-0 bg-[#7ED956] bg-opacity-1 flex items-center justify-center w-3/4 xl:w-1/4 mx-auto translate-y-1/2 sm:translate-y-1/3 md:translate-y-1/4 lg:translate-y-1/5 rounded-[18px] pb-2 sm:pb-4 md:pb-6 lg:pb-8">        
